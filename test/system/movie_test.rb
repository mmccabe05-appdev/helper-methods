...
# testing my added model

class DirectorsTest < ApplicationSystemTestCase
  test "Does the directors page have?" do
    visit "/directors"
...
class MoviesTest < ApplicationSystemTestCase
  test "does the index have H1?" do
    visit "/movies"
    assert_selector "h1", text: "List of all movies"
  end

  # added from sample file
  ...
  test "creating a Movie" do
    ...
    click_on "Create Movie" # note updated this because the original test had lowercase, helper methods capitalize
  ...
  test "updating a Movie" do
    ...
    click_on "Update Movie" # note updated this because the original test had lowercase, helper methods capitalize
